...
| [TECH-0058-optimize-app-before-future-work.md](./TECH-0058-optimize-app-before-future-work.md) | Plan and apply optimizations before expanding the app (bundle, code quality, TECH-1005 alignment). | Deferred — bulk run |
