    ...
    <form action={formAction} className="flex w-full flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        {initialValues?.imageUrl ? (
          <div className="mt-1 flex min-h-[8rem] items-center justify-center overflow-hidden rounded-lg border border-blue-100 bg-zinc-50">
            {/* eslint-disable-next-line @next/next/no-img-element -- user-pasted URL, arbitrary host */}
            <img
              src={initialValues.imageUrl}
              alt=""
              className="max-h-32 max-w-full rounded-lg object-contain object-center"
            />
          </div>
        ) : null}
      </div>
