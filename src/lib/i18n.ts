...
const messages = {
  en: {
    ...
    settings: {
      ...
      creatingApiToken: "Creating…",
      apiTokenCreated: "Token “{name}” created.",
      apiTokenShownOnce: "Copy it now — it is shown only once and cannot be recovered later.",
      copyApiToken: "Copy token",
      apiTokenCopied: "Copied",
      apiTokenCopyFailed: "Could not copy. Select the token and copy it manually.",
      apiNoTokens: "You have no API tokens yet.",
      apiTokenCreatedOn: "Created {date}",
      apiTokenLastUsed: "Last used {date}",
      apiTokenNeverUsed: "Never used",
      revokeApiToken: "Revoke",
      revokingApiToken: "Revoking…",
      revokeApiTokenConfirm:
        "Revoke the token “{name}”? Anything using it will immediately lose API access.",
  ...
  fr: {
    ...
    settings: {
      ...
      creatingApiToken: "Création…",
      apiTokenCreated: "Jeton « {name} » créé.",
      apiTokenShownOnce:
        "Copiez-le maintenant — il n'est affiché qu'une seule fois et ne peut pas être récupéré plus tard.",
      copyApiToken: "Copier le jeton",
      apiTokenCopied: "Copié",
      apiTokenCopyFailed: "Impossible de copier. Sélectionnez le jeton et copiez-le manuellement.",
      apiNoTokens: "Vous n'avez pas encore de jetons API.",
      apiTokenCreatedOn: "Créé le {date}",
      apiTokenLastUsed: "Dernière utilisation {date}",
      apiTokenNeverUsed: "Jamais utilisé",
      revokeApiToken: "Révoquer",
      revokingApiToken: "Révocation…",
      revokeApiTokenConfirm:
        "Révoquer le jeton « {name} » ? Tout ce qui l'utilise perdra immédiatement l'accès à l'API.",
  ...
  pidgin: {
    ...
    settings: {
      ...
      createApiToken: "Create token",
      creatingApiToken: "Dey create…",
      apiTokenCreated: "Token “{name}” don ready.",
      apiTokenShownOnce: "Copy am now — na only one time we go show am, you no fit see am again later.",
      copyApiToken: "Copy token",
      apiTokenCopied: "E don copy",
      apiTokenCopyFailed: "We no fit copy am. Select di token copy am yourself.",
      apiNoTokens: "You never get any API token.",
      apiTokenCreatedOn: "Created {date}",
      apiTokenLastUsed: "Last used {date}",
      apiTokenNeverUsed: "Never used",
      revokeApiToken: "Revoke",
      revokingApiToken: "Dey revoke…",
      revokeApiTokenConfirm:
        "Revoke di token “{name}”? Anything wey dey use am go lose API access sharp sharp.",
      apiTokenRevoked: "API token don revoke.",
    },
    tasksPage: {
      title: "Work",
      addTask: "Put work",
